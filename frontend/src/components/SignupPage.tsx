...
import {
    ...
    Image, Input, InputGroup, InputLeftElement, InputRightElement, Stack, useColorModeValue, useTab, useToast
...
const LoginPage = () => {
    ...
    function msg(msg: string) {
        ...
        console.log("msg", msg);
        const i = msg.indexOf("(");
        const msg2 = msg.slice(i + 1, msg.length - 2);
        ...
        const msgs: { [key: string]: string } = {
            ...
            "auth/user-cancelled": "User did not grant application the permissions it requested.",
            "auth/user-not-found": "Email not found",
            "auth/user-disabled": "Email account has been disabled by an administrator.",
            "auth/user-mismatch": "Supplied credentials do not correspond to the previously signed in user.",
            "auth/weak-password": "Password must be 6 characters long or more.",
